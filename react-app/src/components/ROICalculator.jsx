...
export function ROICalculator() {
  ...
  // Calculate ROI whenever form values change
  useEffect(() => {
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          <Card className="p-6 border-border/60 bg-card">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-3 bg-secondary/50 rounded-lg px-3 -mx-3">
                ...
                <span
                  className={`text-lg font-bold ${results.isCashFlowPositive ? "text-emerald-600" : "text-rose-500"}`}
                >
        ...
        <div className="lg:hidden fixed bottom-4 left-4 right-4 z-50">
          <button
            ...
            className={`w-full py-4 px-6 rounded-xl font-semibold text-white shadow-lg flex items-center justify-between ${results.isCashFlowPositive ? "bg-emerald-500" : "bg-rose-500"
              }`}
          >
